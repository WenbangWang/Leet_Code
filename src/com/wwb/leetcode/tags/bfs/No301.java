...
//        return solution1(s);
    ...
    private void dfs(String s, int pointer, int numberOfExtraLeftParen, int numberOfExtraRightParen, int openParen, Set<String> result, StringBuilder stringBuilder) {
        ...
        if(c == '(') {
            ...
            dfs(s, pointer + 1, numberOfExtraLeftParen, numberOfExtraRightParen, openParen + 1, result, stringBuilder.append(c));
        } else if(c == ')') {
            dfs(s, pointer + 1, numberOfExtraLeftParen, numberOfExtraRightParen - 1, openParen, result, stringBuilder);
            dfs(s, pointer + 1, numberOfExtraLeftParen, numberOfExtraRightParen, openParen - 1, result, stringBuilder.append(c));
        } else {
            dfs(s, pointer + 1, numberOfExtraLeftParen, numberOfExtraRightParen, openParen, result, stringBuilder.append(c));
        }
